@extends('layouts.cp')
@section('title') {{ucwords(__('cp.new_subcategory'))}}
@endsection
@section('css')
@endsection
@section('content')
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase"
                              style="color: #e02222 !important;">{{__('cp.new_subcategory')}}</span>
                    </div>
                </div>
                <div class="portlet-body form">
                    <form method="post" action="{{url(app()->getLocale().'/admin/subCategories')}}"
                        ...
                        <div class="form-body">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control select2" name="parent_id" required  id="category_id">
                                            <option value="" > {{__('common.select')}}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <textarea rows="5" class="form-control" name="details_{{$locale->lang}}"
                                                   ...
                                                   id="details_{{$locale->lang}}" required>{{ old('details_'.$locale->lang) }}</textarea>
                                        </div>
                                    </div>
