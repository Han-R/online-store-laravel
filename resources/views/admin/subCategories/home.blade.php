@extends('layouts.cp')
@section('title') {{__('cp.subcategories')}}
@endsection
@section('css')
@endsection
@section('content')
        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            <a href="{{url(getLocal().'/admin/subCategory/create')}}" style="margin-right: 5px"
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                ...
                <tr>
                    ...
                    <th> {{ucwords(__('common.maincategory'))}}</th>
                    <th> {{ucwords(__('common.department'))}}</th>
                    ...
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                <a href="{{url(getLocal().'/admin/subCategory/'.$item->id.'/edit')}}"
...
@section('script')
    <script>
        ...
        function delete_adv(id,iss_id, e) {
            //alert(id);
            e.preventDefault();
            var url = '{{url(getLocal()."/admin/subCategory")}}/' + id;
