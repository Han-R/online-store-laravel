@extends('layouts.cp')
@section('title') {{ucwords(__('common.edit'))}} {{ucwords(__('common.page'))}}
@endsection
@section('css')
@endsection
@section('content')
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase"
                              style="color: #e02222 !important;">{{__('common.edit')}}{{__('common.page')}}</span>
                    </div>
                </div>
                            ...
                            @foreach($locales as $locale)
                                <fieldset>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" disabled class="form-control" name="key_words_{{$locale->lang}}" value="{{$item->translate($locale->lang)->keywords}}" id="order"
                                ...
                                <div class="form-group {{ $errors->has('image') ? ' has-error' : '' }}">
                                    <div class="col-md-6 col-md-offset-3">
                                        ...
                                        <div class="fileinput-new thumbnail"
                                            ...
                                            <img src="@if($item->image){{$item->image}} @else  {{url('images/ChoosePhoto.png')}} @endif" id="editImage">
                                        </div>
