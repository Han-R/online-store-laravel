...
@section('content')
    <div class="portlet light bordered">
        <div class="portlet-body">
                ...
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            ...
                            <input type="hidden" id="urlToChangeStatus" value="{{url(getLocal()."/admin/changeStatus/products")}}">
                        </div>
                    </div>
                </div>
            ...
            <input type="hidden" id="url" value="{{url(app()->getLocale()."/admin/products_changeStatus")}}">
                    ...
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                ...
                                <a href="{{url(getLocal().'/admin/quantities/'.$item->id)}}"
                                   class="btn btn-xs blue tooltips" data-container="body" data-placement="top"
                                   data-original-title="{{__('common.quantity')}}">{{__('common.quantity')}}
                                </a>
