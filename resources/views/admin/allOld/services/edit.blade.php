@extends('layout.app')
@section('title') {{ucwords(__('common.edit'))}}{{ucwords(__('bunch.service'))}}
@endsection
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase"
                              style="color: #e02222 !important;">{{ucwords(__('common.edit'))}}{{ucwords(__('bunch.service'))}}</span>
                    </div>
                </div>
                <div class="portlet-body form">
                    <form method="post" action="{{url(app()->getLocale().'/admin/services/'.$item->id)}}"
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                @foreach($item->services as $attatchment)
