        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                ...
                <div class="box-filter-collapse">
                    <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/services')}}">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="{{url('admin/services')}}" type="submit"
            ...
            <input type="hidden" id="url" value="{{url(app()->getLocale()."/admin/services_changeStatus")}}">
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                ...
                <tr>
                    ...
                    <th> {{ucwords(__('bunch.service_provider_name'))}}</th>
                    <th> {{ucwords(__('bunch.name_services'))}}</th>
                    ...
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                <a href="{{url(getLocal().'admin'.$item->id.'/edit')}}"
...
@section('script')
    <script>
            ...
            console.log(id);
            console.log(iss_id);
                    var url = '{{url(getLocal()."/admin/services")}}/' + id ;
