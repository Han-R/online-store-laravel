@extends('layout.app')
@section('title') {{ucwords(__('users.user_edit'))}}
@endsection
@section('css')
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase"
                              style="color: #e02222 !important;">{{__('common.edit')}}{{__('users.user')}}</span>
                    </div>
                </div>
                                ...
                                <div class="col-md-6">
                                    <select class="form-control select2" name="verification" required  id="category_id">
                                        <option value="" > {{__('common.select')}}</option>
                                            ...
                                            <option value="0"  @if($item->verification == 0 OR $item->verification == 5) selected @endif >
                                                {{__('common.unverfied')}}
                                            </option>
