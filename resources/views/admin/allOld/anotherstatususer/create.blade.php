@extends('layout.app')
@section('title') {{ucwords(__('bunch.driver_add'))}}
@endsection
@section('css')
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase"
                              style="color: #e02222 !important;">{{__('bunch.driver_add')}}</span>
                    </div>
                </div>
                <div class="portlet-body form">
                    <form method="post" action="{{url(app()->getLocale().'/admin/anotherstatus_user')}}"
                        ...
                        <div class="form-body">
                            ...
                            <div class="modal-body">
                                <fieldset>
                                    ...
                                    <div class="form_area">
                                        <input type="hidden" required name="location" id="location" value="">
                                        <input type="hidden" required name="lat" id="lat" value="">
                                        <input type="hidden" required name="lan" id="lng" value="">
                                    </div>
