@extends('layout.app')
@section('title') {{ucwords(__('bunch.editـpassword_deiver'))}}
@endsection
@section('css')
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase"
                              style="color: #e02222 !important;">{{ucwords(__('bunch.editـpassword_deiver'))}}</span>
                    </div>
                </div>
                <div class="portlet-body form">
                    <form method="post" action="{{url(app()->getLocale().'/admin/anotherstatus_user/'.$item->id.'/edit_password')}}"
...
<fieldset>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" disabled  class="form-control" name="name" value="{{$item->name}}"
