...
@section('content')
    <div class="portlet light bordered">
        <div class="portlet-body">
            ...
            <input type="hidden" id="url" value="{{url("/en/admin/slider_home/changeStatus")}}">
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                ...
                <tr>
                    ...
                    <th> {{ucwords(__('slider.youtube_url'))}}</th>
                ...
                @forelse($items as $item)
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
                        ...
                        <td> {{$item->title}}</td>
                        <td> <?php echo ($item->youtube_url == null) ? "No Path" : $item->youtube_url?></td>
                        <td>
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                <a href="{{url(getLocal().'/admin/slider_home/'.$item->id.'/edit')}}"
