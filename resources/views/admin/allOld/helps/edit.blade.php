                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase"
                              style="color: #e02222 !important;">{{__('common.edit')}}{{__('common.FAQS')}}</span>
                    </div>
                </div>
                        ...
                        <div class="form-body">
                            ...
                            <fieldset>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="question_{{$locale->lang}}" value="{{ $helps->question}}" id="order"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <textarea type="text" class="form-control" name="answer_{{$locale->lang}}"  id="order"
                                               placeholder=" {{__('common.answer_'.$locale->lang)}}" >{{$helps->answer }}</textarea>
                                    </div>
                                </div>
                            </fieldset>
                            @endforeach
