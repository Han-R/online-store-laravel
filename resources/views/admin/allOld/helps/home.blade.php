        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            <a href="{{url(getLocal().'/admin/helps/create')}}" style="margin-right: 5px"
                ...
                <div class="box-filter-collapse">
                    <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/helps')}}">
                        <div class="row">
                            <div class="col-md-4">
            ...
            <input type="hidden" id="url" value="{{url(app()->getLocale()."/admin/helps_changeStatus")}}">
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                ...
                <tr>
                    ...
                    <th> {{ucwords(__('common.QUESTIONS'))}}</th>
                    <th> {{ucwords(__('common.ANSWER'))}}</th>
                    ...
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
                        <td>
                            <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                ...
                                <span></span>
                                 ...
                                 <td>{{$item->translate(app()->getLocale())->question}}</td>
                                <td>{{$item->translate(app()->getLocale())->answer}}</td>
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                <a href="{{url(getLocal().'/admin/helps/'.$item->id.'/edit')}}"
...
@section('script')
    <script>
        ...
        function delete_adv(id,iss_id, e) {
            ...
            console.log(id);
            console.log(iss_id);
            var url = '{{url(getLocal()."/admin/helps")}}/' + id;
