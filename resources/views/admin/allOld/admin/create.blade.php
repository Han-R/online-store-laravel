@extends('layout.app')
@section('title')
    {{__('common.add')}} {{__('clinic.clinic')}} {{__('common.owner')}}
@endsection
@section('css')
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase"
                              style="color: #e02222 !important;">{{__('common.add')}} {{__('clinic.clinic')}} {{__('common.owner')}}</span>
                    </div>
                </div>
                <div class="portlet-body form">
                    <form method="post" action="{{url(app()->getLocale().'/admin/owner_admin')}}"
