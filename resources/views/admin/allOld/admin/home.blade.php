@extends('layout.app')
@section('title') {{ucwords(__('common.owner'))}}
@endsection
@section('css')
@endsection
@section('content')
        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                        <a href="{{url(getLocal().'/admin/owner_admin/create')}}" style="margin-right: 5px"
                ...
                <div class="box-filter-collapse">
                    <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/owner_admin')}}">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="{{url('admin/owner_admin')}}" type="submit"
                    ...
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                <a href="{{url(getLocal().'/admin/owner_admin/'.$item->id.'/edit')}}"
                                   class="btn btn-xs blue tooltips" data-container="body" data-placement="top"
                                   data-original-title="{{__('common.edit')}}"><i class="fa fa-edit"></i></a>
                                <a href="{{url(getLocal().'/admin/owner_admin/'.$item->id.'/edit_password')}}"
                                   class="btn btn-xs blue tooltips" data-container="body" data-placement="top"
...
@section('script')
    <script>
         ...
         function delete_adv(id,iss_id, e) {
            ...
            console.log(id);
            console.log(iss_id);
             var url = '{{url(getLocal()."/admin/owner_admin")}}/' + id;
